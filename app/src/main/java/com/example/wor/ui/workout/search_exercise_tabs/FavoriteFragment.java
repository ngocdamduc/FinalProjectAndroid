...
public class FavoriteFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        // Observe live data
        mViewModel.getAllAvailableFavoriteExercise(true, mExerciseTypeInput).observe(getViewLifecycleOwner(), (List<AvailableExerciseItem> availableFavoritedExercises) -> {

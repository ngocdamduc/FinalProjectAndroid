...
public interface AvailableExerciseDao {
    ...
    @Query("SELECT * FROM available_exercise_table WHERE  favorite = :favorite AND exercise_type = :exerciseType")
    LiveData<List<AvailableExerciseItem>> getAllFavoriteAvailableExercise(boolean favorite, ExerciseType exerciseType);
